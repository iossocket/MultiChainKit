...
extension CairoValue {
  ...
  public static func decode(type: CairoType, from calldata: [Felt], at offset: Int = 0) throws -> (CairoValue, Int) {
    ...
    switch (type) {
      ...
      case .byteArray:
        ...
        let ba = CairoByteArray(fullWords: fullWords, pendingWord: pendingWord, pendingWordLen: pendingWordLen)
