...
public enum BIP32 {
    ...
    private static let fieldPrime = BigUInt("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFC2F", radix: 16)!
    private static let Gx = BigUInt("79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798", radix: 16)!
    private static let Gy = BigUInt("483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8", radix: 16)!
    ...
    public static func deriveChild(from parent: ExtendedKey, index: UInt32, hardened: Bool) throws -> ExtendedKey {
        var data = Data()
    ...
    private static func pointAdd(x1: BigUInt, y1: BigUInt, x2: BigUInt, y2: BigUInt) -> (BigUInt, BigUInt) {
        let p = fieldPrime
