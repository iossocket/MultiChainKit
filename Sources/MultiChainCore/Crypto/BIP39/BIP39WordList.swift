...
public enum BIP39WordList {
  ...
  public static let english: [String] = [
    ...
    "embody",
    "embrace", "emerge", "emotion", "employ", "empower", "empty", "enable", "enact", "end",
    "endless",
    ...
    "indicate",
    "indoor", "industry", "infant", "inflict", "inform", "inhale", "inherit", "initial", "inject",
    "injury",
    "inmate", "inner", "innocent", "input", "inquiry", "insane", "insect", "inside", "inspire",
    "install",
    "intact", "interest", "into", "invest", "invite", "involve", "iron", "island", "isolate",
    "issue",
    ...
    "market",
    "marriage", "mask", "mass", "master", "match", "material", "math", "matrix", "matter",
    "maximum",
    ...
    "more", "morning", "mosquito", "mother", "motion", "motor", "mountain", "mouse", "move",
    "movie",
    ...
    "pyramid", "quality", "quantum", "quarter", "question", "quick", "quit", "quiz", "quote",
    "rabbit",
  ...
  // TODO: Add real word lists
  public static let chineseSimplified: [String] = english
  public static let chineseTraditional: [String] = english
  public static let japanese: [String] = english
}
